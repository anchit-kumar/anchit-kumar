...
- Skills: Python (Syntax + Basic Django + Basic Apache Spark + Micro Python + AI), C++ (Syntax, A little WebGL), C (Syntax + Embedded), Java (Syntax + Applets + Servlets&JSP), Frontend (HTML, CSS, React JS).
